...
** TODO logo + favicon
** TODO move all the local context stuff to server side (e.g. moon phase etc) -> create proper context.clj controller
** TODO use 🌒 emojis in prompt again (they're cute)
** TODO figure out a more sane TZ to heuristic lat long
