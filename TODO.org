...
** TODO proper timezone for human-today on initial render (use https://ipgeolocation.io/timezone-api.html)
** TODO move llama parameters into system.edn
** TODO set guards around weather and other local context in prompt-template
