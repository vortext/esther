(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sentiment"] = factory();
	else
		root["sentiment"] = factory();
})(self, () => {
...
const Sentiment = __webpack_require__(/*! sentiment */ "./lib/index.js");
module.exports = Sentiment;


/***/ }),

/***/ "./languages/en/index.js":
/*!*******************************!*\
  !*** ./languages/en/index.js ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = {
    labels: __webpack_require__(/*! ./labels.json */ "./languages/en/labels.json"),
    scoringStrategy: __webpack_require__(/*! ./scoring-strategy */ "./languages/en/scoring-strategy.js")
};
...
var negators = __webpack_require__(/*! ./negators.json */ "./languages/en/negators.json");
...
/***/ "./languages sync recursive ^\\.\\/.*\\/index$":
/*!*****************************************!*\
  !*** ./languages/ sync ^\.\/.*\/index$ ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./en/index": "./languages/en/index.js"
};
...
webpackContext.id = "./languages sync recursive ^\\.\\/.*\\/index$";
...
var tokenize = __webpack_require__(/*! ./tokenize */ "./lib/tokenize.js");
var languageProcessor = __webpack_require__(/*! ./language-processor */ "./lib/language-processor.js");
...
var emojis = __webpack_require__(/*! ../build/emoji.json */ "./build/emoji.json");

// English is loaded by default
var enLanguage = __webpack_require__(/*! ../languages/en/index */ "./languages/en/index.js");
// Add emojis
...
module.exports = {
    ...
    getLanguage: function(languageCode) {
        ...
        if (!languages[languageCode]) {
            ...
            try {
                // eslint-disable-next-line max-len
                var language = __webpack_require__("./languages sync recursive ^\\.\\/.*\\/index$")("./" + languageCode + "/index");
