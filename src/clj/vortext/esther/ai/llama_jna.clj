;; From https://github.com/phronmophobic/llama.clj
;; The MIT License (MIT)
;; Copyright © 2023 Adrian Smith
;; Warning this doesn't currently (20230829) work with master of llama.cpp
;; It's only used for it's token counting ability
(ns vortext.esther.ai.llama-jna
  (:require [vortext.esther.ai.llama.raw :as raw]
